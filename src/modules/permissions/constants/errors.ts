 ...
 * All error messages related to permission operations
 */
export const PERMISSION_ERRORS = {
  //CRUD Operations
  CREATE_PERMISSION_ERROR: "Failed to create permission",
  ...
  ERROR_LOADING_PERMISSION: "Error loading permission",
};
